...
if(e.data===YT.PlayerState.PLAYING){youtube_videos[element.attr('id')].manually_paused=!1}}},},});temp={player:player,played_once:!1,manually_paused:!1,};youtube_videos[element.attr('id')]=temp})});return def.promise()}
