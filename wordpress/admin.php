...
class CrellySliderAdmin {
	...
	public static function localization() {
		...
		$crellyslider_translations = array(
			...
			'text_element_default_html' => __('<span style="font-family: Montserrat; font-size: 60px; font-weight: 900;">Text element</span>', 'crelly-slider'),
	...
	private static function tinyMCEDefaultOptions() {
		...
		return array(
			...
			// 'toolbar3' => '',
			'toolbar1' => 'bold,italic,strikethrough,alignleft,aligncenter,alignright,underline,forecolor,backcolor',
			'toolbar2' => 'fontselect,fontsizeselect',
			'toolbar3' => 'styleselect,removeformat',
			'font_formats' => 'Montserrat=Montserrat;Lato=Lato',
			'fontsize_formats' => '24px 28px 36px 48px 60px 72px 84px 96px',
			'style_formats' => "[{title: 'Weight : 900', inline: 'span', styles: { fontWeight: '900'}}, {title: 'Weight : 600', inline: 'span', styles: { fontWeight: '600'}},]",
			'toolbar4' => '',
			'height' => 200,
			...
			'entity_encoding' => 'raw',
			'keep_styles' => false,
			'preview_styles' => 'font-family font-weight font-style text-decoration text-transform',
